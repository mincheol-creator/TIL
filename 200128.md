...
$(document).ready(function() {
    ...
    $('#login_btn').click(function() {
        ...
        $.post('login', send_param, function(returnData) { //server로 보내기(경로, send, function)
            alert(returnData.message);
            ...
            if (result == "a") {
                ...
                /* let logout_div_html = "<div id='logout_div'>";
                logout_div_html += returnData.message;
                logout_div_html += "<input class='btn btn-primary' type='button' value='logout' id=logout_btn'>";
                logout_div_html += "</div>"; */
    ...
    $('#basic_btn').click(function() {
        const send_param = { product: "basic" };
    ...
    $('#premium_btn').click(function() {
        const send_param = { product: "premium" };
        $.post('basket', send_param, function(returnData) {
            alert(returnData.message);
            $('#basket_div').html(returnData.message);
        });
    ...
    <div class="jumbotron text-center">
        ...
        <form id="login_form">
            <div class="input-group" id="login_div">
                <input id="login_email" type="email" class="form-control" size="50" value="abc@a.b" required>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-footer">
                        <h3>$19</h3>
                        <h4>per month</h4>
                        <button id="basic_btn" class="btn btn-lg">Sign Up</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-footer">
                        <h3>$29</h3>
                        <h4>per month</h4>
                        <button id="pro_btn" class="btn btn-lg">Sign Up</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-footer">
                        <h3>$49</h3>
                        <h4>per month</h4>
                        <button id="premium_btn" class="btn btn-lg">Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-7 slideanim">
                ...
                <div class="row">
                    <div class="col-sm-12 form-group">
                        <input class="btn btn-default pull-right" type="button" value="Send" id="contact_btn" />
                    </div>
                </div>
            </div>
        </div>
...
const members = [
    { name: 'a', email: 'abc@a.b', comments: 'e' },
    { name: 'f', email: 'g@h.i', comments: 'j' }
];
